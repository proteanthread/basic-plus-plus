...
/* Phase 4: BValue expression parsing */
...
static void parse_print(Lexer *lex, RuntimeState *rt, int line_num)
{
    ...
    char sep;
    int file_chan = 0;     /* Phase 11: 0=stdout, 1-8=file channel */
...
static void parse_input(Lexer *lex, RuntimeState *rt, int line_num)
{
    ...
    int file_chan = 0;     /* Phase 11: 0=stdin, 1-8=file channel */
...
static void parse_goto(Lexer *lex, RuntimeState *rt, int line_num)
{
...

    {
        ...
        /* Phase 12: Use VM control flow primitive */
...
static void parse_stop(Lexer *lex, RuntimeState *rt, int line_num)
{
    ...
    /* Phase 17: Use VM_PAUSED so CONT can resume */
...
/* =====================================================================
 * Loop Statement Handlers (Phase 2)
 * =====================================================================
 ...
 *
 * Phase 8: Calls dialect_apply() after switching to reconfigure
...
/* =====================================================================
 * DEF FN - User-Defined Functions (Phase 9)
 * =====================================================================
 *
 * SYNTAX:
 *   DEF FNA(X) = X*X+1
...
/* =====================================================================
 * MAT - Matrix Operations (Phase 10)
 * =====================================================================
 *
 ...
 * Phase 2 loops). INPUT/OUTPUT/APPEND are detected as identifiers.
 */
    ...
    if (lex->current.type == TOK_KEYWORD) {
        ...
        switch (kw) {
            ...
            case KW_DIALECT:
                ...
                return;
            /* Phase 9: DEF FN - user-defined functions */
            case KW_DEF:
                parse_def_fn(lex, rt, line_num);
                return;
            /* Phase 10: MAT - matrix operations */
            case KW_MAT:
            ...
            case KW_CLOSE:
                ...
                return;
            /* ECMA-116 Phase 5: Enhanced Files */
            case KW_SET:
...
static long parse_factor(Lexer *lex, RuntimeState *rt, int line_num)
{
    ...
    switch (lex->current.type) {
        ...
        case TOK_KEYWORD:
            /*
             * Phase 9: User-defined function dispatch.
            ...
            /*
             * Phase 7: Registry-based function dispatch.
             *
...
/* =====================================================================
 * Phase 4: BValue Expression System
 * =====================================================================
...
static BValue parse_factor_bval(Lexer *lex, RuntimeState *rt, int line_num)
{
    ...
    switch (lex->current.type) {
        ...
        case TOK_KEYWORD:
            ...
            /*
             * Phase 7: Registry-based BValue function dispatch.
             *
