...
static const HelpEntry help_db[] = {
 ...
 { "HASH$", "Hash string to hex (FNV-1a, 8/16/32/64/128/256 bit)",
 "PRINT HASH$(\"test\") or HASH$(\"test\",64)",
                                          HCAT_STRING },
 { "ICASE$", "Invert case (swap upper/lower)",
 "PRINT ICASE$(\"Hello\")  ' hELLO",      HCAT_STRING },
 { "INSTR", "Find substring position (2 or 3 args)",
 "INSTR(\"HELLO\",\"LL\") or INSTR(3,\"HELLO\",\"L\")",
                                          HCAT_STRING },
 ...
 { "LIKE", "Pattern match (glob: * ? # [abc] [!abc])",
 "IF A$ LIKE \"H*\" THEN PRINT \"match\"",
                                          HCAT_STRING },
 { "LTRIM$", "Remove leading spaces",
 "PRINT LTRIM$(\"  hello\")",            HCAT_STRING },
 { "MCASE$", "Mixed/random case (uses RNG)",
 "RANDOMIZE 42: PRINT MCASE$(\"hello\")", HCAT_STRING },
 { "MID$", "Substring or statement form",
 "PRINT MID$(\"HELLO\",2,3) or MID$(A$,3)=\"X\"",
                                          HCAT_STRING },
 ...
 "PRINT REPLACE$(\"aabbcc\",\"bb\",\"XX\")",
                                          HCAT_STRING },
 { "REVERSE$", "Reverse a string",
 "PRINT REVERSE$(\"HELLO\")  ' OLLEH",   HCAT_STRING },
