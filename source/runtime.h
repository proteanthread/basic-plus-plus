...
/* =====================================================================
 * User-Defined Function Entry (Phase 9)
 * =====================================================================
 ...
 *   named_vars    - named variable table (Phase 3)
 ...
 *   user_funcs    - DEF FN function table (Phase 9)
...
typedef struct RuntimeState {
    ...
    /* Phase 3: named variables */
    NamedVariable named_vars[MAX_NAMED_VARS];
    int           named_count;
    /* Phase 3: DATA pool (now BValue for mixed types) */
    BValue        data_pool[MAX_DATA_ITEMS];
    int           data_count;
    int           data_ptr;
    /* Phase 4: string variables A$-Z$ */
    ...
    /* Phase 6: trace system (TRON/TROFF) */
    int           trace_on;         /* 1 = trace active */
    /* Phase 6: error handler (ON ERROR GOTO) */
    ...
    /* Phase 9: user-defined functions (DEF FN) */
    UserFunction  user_funcs[MAX_USER_FUNCS];
    int           user_func_count;
    /* Phase 12: VM state machine */
    int           vm_state;         /* VMState enum value */
    /* Phase 12: expression evaluation stack (vm.h) */
...
/*
 * runtime_get_var_bval - Get variable as BValue (Phase 4).
 */
...
/*
 * runtime_set_var_bval - Set variable from BValue (Phase 4).
 */
...
/*
 * Phase 17: Interactive debugger functions.
 */
...
/* =====================================================================
 * DATA Pool (Phase 3, extended in Phase 4 for BValue)
 * =====================================================================
 */
