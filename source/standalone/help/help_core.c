...
#define HCAT_FLOW HCAT_CORE_FLOW
#define HCAT_IO HCAT_CORE_IO
#define HCAT_MATH HCAT_CORE_MATH
#define HCAT_STRING HCAT_CORE_STRING
#define HCAT_VARMEM HCAT_CORE_VARMEM
#define HCAT_FILEIO HCAT_CORE_FILEIO
#define HCAT_GFX HCAT_CORE_GFX
#define HCAT_SOUND HCAT_CORE_SOUND
#define HCAT_SYSENV HCAT_CORE_SYSENV
#define HCAT_DEBUG HCAT_CORE_DEBUG
#define HCAT_PROGMGMT HCAT_CORE_PROGMGMT
#define HCAT_EDIT HCAT_CORE_EDIT
#define HCAT_DEVICE HCAT_CORE_DEVICE
#define HCAT_OPER HCAT_CORE_OPER
#define HCAT_INTRO HCAT_CORE_INTRO
#define HCAT_SYSVAR HCAT_CORE_SYSVAR
...
static const HelpEntry help_db[] = {
    ...
    { "EVAL", "Evaluate mathematical string expression", "EVAL(\"A+B*2\")", HCAT_MATH },
...
static const HelpEntry help_db[] = {
  ...
  { "EVAL", "Evaluate mathematical string expression",
    "PRINT EVAL(\"A+B*2\")", HCAT_MATH },
