...
static void exec_run_from(RuntimeState *rt, int start_index)
{
    ...
    while (vm_get_state(rt) == VM_RUNNING &&
        ...
        /*
         * Phase 17: Breakpoint / single-step check.
        ...
        /*
         * Phase 6: Trace output (TRON/TROFF).
         */
        if (rt->trace_on) {
        ...
        /*
         * Phase 6: Suppress error messages when ON ERROR GOTO
        ...
        /*
         * Phase 17: Check if STOP paused execution.
...
void exec_run(RuntimeState *rt)
{
    ...
    /* Phase 3: Collect DATA values before execution begins */
