...
Extracts an attribute, value, or subvalue from a Pick dynamic array string.

## 2. Syntax

```basic
EXTRACT(dyn_arr, attr [, val [, subval]])
```

## 3. Code Example

```basic
10 Val = EXTRACT(dyn_arr, attr [, val [, subval]])
20 PRINT "Result: "; Val
```
