...
Authority:    engine/src/eval/functions/math/financial/irr.c
Generated:    no, hand-written
Status:       current
-->

# `IRR` Keyword Reference
...
| Compatibility | none |
| Since Version | none |
| Source File | engine/src/eval/functions/math/financial/irr.c |
