...
Authority:    engine/src/eval/functions/ui/dialogs/fileopenbox.c
Generated:    no, hand-written
Status:       current
-->

# `FILEOPENBOX$` Keyword Reference
...
Displays a file open dialog and returns the chosen filename.

## 2. Syntax

```basic
f$ = FILEOPENBOX$([pattern$ [, title$ [, default$]]])
```

## 3. Code Example

```basic
10 Val = f$ = FILEOPENBOX$([pattern$ [, title$ [, default$]]])
20 PRINT "Result: "; Val
```
...
| Compatibility | none |
| Since Version | none |
| Source File | engine/src/eval/functions/ui/dialogs/fileopenbox.c |
