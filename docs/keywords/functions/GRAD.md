...
Sets trigonometric evaluation mode to gradians (Sharp Pocket BASIC PC-1211/PC-1500 / Casio).
...
```basic
10 REM GRAD Demonstration
20 PRINT "GRAD executed successfully."
```
