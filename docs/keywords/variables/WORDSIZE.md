...
Target machine word size in bits (32 or 64).

## 2. Syntax

```basic
WORDSIZE or SYS.WORDSIZE
```

## 3. Code Example

```basic
10 REM WORDSIZE Demonstration
20 PRINT "WORDSIZE executed successfully."
```
...
| Name | WORDSIZE |
| Category | System Identification |
| Syntax | WORDSIZE or SYS.WORDSIZE |
