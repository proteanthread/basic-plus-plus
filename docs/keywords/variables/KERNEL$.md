...
Returns host operating system kernel and build version string.

## 2. Syntax

```basic
KERNEL$ or SYS.KERNEL$
```

## 3. Code Example

```basic
10 REM KERNEL$ Demonstration
20 PRINT "KERNEL$ executed successfully."
```
