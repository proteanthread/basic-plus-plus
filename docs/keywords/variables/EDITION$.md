...
BASIC++ edition name (Standard Edition, Lite Edition, Batch Runner, IoT).

## 2. Syntax

```basic
EDITION$ or SYS.EDITION$
```

## 3. Code Example

```basic
10 REM EDITION$ Demonstration
20 PRINT "EDITION$ executed successfully."
```
