...
Returns the absolute filesystem path of the running executable.
...
```basic
10 REM EXEPATH$ Demonstration
20 PRINT "EXEPATH$ executed successfully."
```
