...
Wi-Fi connection status string ('CONNECTED', 'DISCONNECTED').
...
```basic
10 REM WIFI.STATUS$ Demonstration
20 PRINT "WIFI.STATUS$ executed successfully."
```
