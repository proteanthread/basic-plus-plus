...
# `NBYTESWAITING` Keyword Reference
...
Returns number of unread bytes waiting in network socket buffer.
...
```basic
10 REM NBYTESWAITING Demonstration
20 PRINT "NBYTESWAITING executed successfully."
```
