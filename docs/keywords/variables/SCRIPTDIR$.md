...
Returns the directory containing the loaded script.

## 2. Syntax

```basic
SCRIPTDIR$ or DIRPATH$
```

## 3. Code Example

```basic
10 REM SCRIPTDIR$ Demonstration
20 PRINT "SCRIPTDIR$ executed successfully."
```
