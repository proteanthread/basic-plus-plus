...
Returns the filename of the loaded script.

## 2. Syntax

```basic
SCRIPTNAME$ or FILENAME$
```

## 3. Code Example

```basic
10 REM SCRIPTNAME$ Demonstration
20 PRINT "SCRIPTNAME$ executed successfully."
```
