...
Returns the full filesystem path of the loaded BASIC++ script.
...
```basic
10 REM SCRIPTPATH$ Demonstration
20 PRINT "SCRIPTPATH$ executed successfully."
```
