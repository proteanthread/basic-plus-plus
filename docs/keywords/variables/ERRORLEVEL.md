...
Returns the return/exit code of the last executed shell command.
...
```basic
10 REM ERRORLEVEL Demonstration
20 PRINT "ERRORLEVEL executed successfully."
```
