...
Returns host temporary files directory path.

## 2. Syntax

```basic
TEMPDIR$ or SYS.TEMPDIR$
```

## 3. Code Example

```basic
10 REM TEMPDIR$ Demonstration
20 PRINT "TEMPDIR$ executed successfully."
```
