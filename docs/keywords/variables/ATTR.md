...
Character cell color attribute byte at screen position.

## 2. Syntax

```basic
ATTR or ATTR(row, col)
```

## 3. Code Example

```basic
10 Val = ATTR or ATTR(row, col)
20 PRINT "Result: "; Val
```
