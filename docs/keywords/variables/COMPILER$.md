...
Host C compiler used to build BASIC++ (MSVC, GCC, Clang).

## 2. Syntax

```basic
COMPILER$ or SYS.COMPILER$
```

## 3. Code Example

```basic
10 REM COMPILER$ Demonstration
20 PRINT "COMPILER$ executed successfully."
```
...
| Name | COMPILER$ |
| Category | System Identification |
| Syntax | COMPILER$ or SYS.COMPILER$ |
