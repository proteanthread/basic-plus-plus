...
Returns -1 if running with administrator / root privileges, 0 otherwise.

## 2. Syntax

```basic
ISADMIN or SYS.ISADMIN or ISROOT
```

## 3. Code Example

```basic
10 REM ISADMIN Demonstration
20 PRINT "ISADMIN executed successfully."
```
...
| Name | ISADMIN |
| Category | Diagnostics |
| Syntax | ISADMIN or SYS.ISADMIN or ISROOT |
