...
Returns network socket connection status (1=connected, 0=disconnected).
...
```basic
10 REM NCONNECTED Demonstration
20 PRINT "NCONNECTED executed successfully."
```
