...
# `SYS.MEMORY.AVAIL` Keyword Reference
...
Namespace query for available physical RAM currently free across the host system in bytes.
...
```basic
10 REM SYS.MEMORY.AVAIL Demonstration
20 PRINT "SYS.MEMORY.AVAIL executed successfully."
```
...
| Field | Value |
|---|---|
| Name | SYS.MEMORY.AVAIL |
| Category | Diagnostics |
| Syntax | SYS.MEMORY.AVAIL |
