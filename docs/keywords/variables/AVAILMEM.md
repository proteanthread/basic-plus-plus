...
Outputs free available physical system memory in bytes to console.
...
```basic
10 REM AVAILMEM Demonstration
20 PRINT "AVAILMEM executed successfully."
```
