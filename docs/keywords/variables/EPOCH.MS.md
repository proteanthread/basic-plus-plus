...
Milliseconds elapsed since 01/01/1980 00:00:00 UTC (MS-DOS epoch).
...
```basic
10 REM EPOCH.MS Demonstration
20 PRINT "EPOCH.MS executed successfully."
```
