...
Active runtime profile (Desktop, Headless, IoT).

## 2. Syntax

```basic
PROFILE$ or SYS.PROFILE$
```

## 3. Code Example

```basic
10 REM PROFILE$ Demonstration
20 PRINT "PROFILE$ executed successfully."
```
