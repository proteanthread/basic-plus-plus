...
Emits an ERROR-severity runtime_log entry to the active logging sinks and circular ring buffer.
...
```basic
10 REM LOGERROR Demonstration
20 PRINT "LOGERROR executed successfully."
```
