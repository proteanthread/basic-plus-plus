...
Emits a signal event to active ON SIGNAL trap handlers and subscribers.

## 2. Syntax

```basic
RAISESIGNAL topic$, payload$
```

## 3. Code Example

```basic
10 REM RAISESIGNAL Demonstration
20 PRINT "RAISESIGNAL executed successfully."
```
