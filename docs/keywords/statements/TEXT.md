...
Authority:    engine/src/statements/filesystem/binary_ops/text.c
...
Opens a file channel in sequential text output mode (SDS 940 / DEC PDP-10 Super BASIC).

## 2. Syntax

```basic
TEXT #channel, "encoding_spec"
```

## 3. Code Example

```basic
10 REM TEXT Demonstration
20 PRINT "TEXT executed successfully."
```
...
| Compatibility | none |
| Since Version | none |
| Source File | engine/src/statements/filesystem/binary_ops/text.c |
