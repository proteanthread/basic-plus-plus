...
Emits a TRACE-severity runtime_log entry to the active logging sinks and circular ring buffer.

## 2. Syntax

```basic
LOGTRACE message$ [, tag$]
```

## 3. Code Example

```basic
10 REM LOGTRACE Demonstration
20 PRINT "LOGTRACE executed successfully."
```
