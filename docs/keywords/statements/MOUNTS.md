...
Lists all currently active mounted virtual filesystem mount points and device types.
...
```basic
10 REM MOUNTS Demonstration
20 PRINT "MOUNTS executed successfully."
```
