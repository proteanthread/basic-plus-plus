...
Transmits raw bytes across GPIB IEEE-488 bus to instrumentation (Tektronix 4050 series).

## 2. Syntax

```basic
WBYTE [@dev [, sec] :] byte1 [, byte2 ...] | WBYTE[dev, sec] byte1 ...
```

## 3. Code Example

```basic
10 REM WBYTE Demonstration
20 PRINT "WBYTE executed successfully."
```
