...
Emits an INFO-severity runtime_log entry to the active logging sinks and circular ring buffer.
...
```basic
10 REM LOGINFO Demonstration
20 PRINT "LOGINFO executed successfully."
```
