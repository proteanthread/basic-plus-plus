...
Sets trigonometric evaluation mode to degrees (Sharp Pocket BASIC PC-1211/PC-1500 / Casio).
...
```basic
10 REM DEGREE Demonstration
20 PRINT "DEGREE executed successfully."
```
