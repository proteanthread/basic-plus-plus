...
Redirects text and character output to Apple II peripheral expansion slot 0..7.
...
```basic
10 REM PR# Demonstration
20 PRINT "PR# executed successfully."
```
