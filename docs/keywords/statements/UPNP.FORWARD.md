...
# `UPNP.FORWARD` Keyword Reference
...
Configures dynamic UPnP / NAT-PMP port forwarding on the local gateway router.
...
Error 57: UPnP port mapping failed on gateway
...
| Error Summary | Error 57: UPnP port mapping failed on gateway |
| Subsystem | SUBSYSTEM_SERVER |
| Safety Level | SAFETY_IO |
