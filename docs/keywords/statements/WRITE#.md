...
Authority:    engine/src/statements/filesystem/file_ops/write_file.c
...
Outputs CSV delimited double-quoted strings and formatted numbers to a disk file channel.

## 2. Syntax

```basic
WRITE #file_num, expression_list
```
...
| Compatibility | none |
| Since Version | none |
| Source File | engine/src/statements/filesystem/file_ops/write_file.c |
