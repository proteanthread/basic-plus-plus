...
### 2. Description & Usage
Returns e raised to the power of the number. Evaluates the input and calculates the result mathematically.
...
- **Lexer**: `source/parser/lexer.c` (`KW_EXP`)
- **AST Node**: `source/parser/ast.c` (`FUNC_EXP`)
- **Runtime Evaluation**: `source/math/builtins_math.c -> builtin_exp()`
...
2. Type: `10 PRINT EXP(1)` and press ENTER.
