...
## 2. Description & Usage
Converts a numeric value to its octal string representation.
...
Implemented by `builtin_octs` in `source/strings/builtins_string.c`. Registration occurs in `source/functions/builtins.c`.
