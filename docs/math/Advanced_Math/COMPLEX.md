...
Initializes a complex number which can be used with other complex math functions like CABS, CEXP, etc.
Edge Cases:
...
File: `source/math/builtins_math.c`, Line: 178, Function: `builtin_complex`

## 5. Implementation Details
Converts arguments to float and packs them into a BValue of type complex using `bval_complex(re, im)`.
...
2. Type `Z = COMPLEX(3, 4)` and press Enter.
3. Type `PRINT CABS(Z)` and press Enter. Verify output is `5`.
