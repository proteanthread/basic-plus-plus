...
### 2. Description & Usage
Converts a number to double precision. Evaluates the input and calculates the result mathematically.
...
- **Lexer**: `source/parser/lexer.c` (`KW_CDBL`)
- **AST Node**: `source/parser/ast.c` (`FUNC_CDBL`)
- **Runtime Evaluation**: `source/math/builtins_math.c -> builtin_cdbl()`
...
2. Type: `10 PRINT CDBL(1)` and press ENTER.
