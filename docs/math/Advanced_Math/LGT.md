...
Synonymous with LOG10. Derived from HP BASIC dialects.
...
Implemented in: `builtins_math.c, builtin_lgt`.

## 5. Implementation Details
Uses math.h log10() function.
...
HP BASIC syntax support.

## 8. Manual Testing Guide
1. Open terminal and run `basicpp-console.exe`
2. Type `PRINT LGT(100)` to verify output matches expected mathematical result.
3. Use invalid inputs (e.g. strings) to test type checking: `PRINT LGT("test")`.
