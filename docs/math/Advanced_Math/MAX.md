...
Implemented in: `builtins_math.c, builtin_max`.

## 5. Implementation Details
Iterates through args, tracks maximum using bval_to_float.
...
Standard multi-argument math function.

## 8. Manual Testing Guide
1. Open terminal and run `basicpp-console.exe`
2. Type `PRINT MAX(4, 7, 2, 9)` to verify output matches expected mathematical result.
3. Use invalid inputs (e.g. strings) to test type checking: `PRINT MAX("test")`.
