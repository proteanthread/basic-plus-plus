...
More precise than computing LOG(x)/LOG(10).
...
Implemented in: `builtins_math.c, builtin_log10`.

## 5. Implementation Details
Uses math.h log10() via builtin_log10.
...
2. Type `PRINT LOG10(1000)` to verify output matches expected mathematical result.
3. Use invalid inputs (e.g. strings) to test type checking: `PRINT LOG10("test")`.
