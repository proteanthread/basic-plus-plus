...
### 2. Description & Usage
Returns the sine of a number. Evaluates the input and calculates the result mathematically.
...
- **Lexer**: `source/parser/lexer.c` (`KW_SIN`)
- **AST Node**: `source/parser/ast.c` (`FUNC_SIN`)
- **Runtime Evaluation**: `source/math/builtins_math.c -> builtin_sin()`
...
2. Type: `10 PRINT SIN(0)` and press ENTER.
