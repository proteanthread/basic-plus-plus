...
### 2. Description & Usage
Returns the cosine of a number. Evaluates the input and calculates the result mathematically.
...
- **Lexer**: `source/parser/lexer.c` (`KW_COS`)
- **AST Node**: `source/parser/ast.c` (`FUNC_COS`)
- **Runtime Evaluation**: `source/math/builtins_math.c -> builtin_cos()`
...
2. Type: `10 PRINT COS(0)` and press ENTER.
