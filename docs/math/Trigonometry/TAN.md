...
### 2. Description & Usage
Returns the tangent of a number. Evaluates the input and calculates the result mathematically.
...
- **Lexer**: `source/parser/lexer.c` (`KW_TAN`)
- **AST Node**: `source/parser/ast.c` (`FUNC_TAN`)
- **Runtime Evaluation**: `source/math/builtins_math.c -> builtin_tan()`
...
2. Type: `10 PRINT TAN(0)` and press ENTER.
