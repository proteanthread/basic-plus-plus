...
### 2. Description & Usage
Returns the hyperbolic cosine of a number. Evaluates the input and calculates the result mathematically.
...
- **Lexer**: `source/parser/lexer.c` (`KW_COSH`)
- **AST Node**: `source/parser/ast.c` (`FUNC_COSH`)
- **Runtime Evaluation**: `source/math/builtins_math.c -> builtin_cosh()`
...
2. Type: `10 PRINT COSH(0)` and press ENTER.
