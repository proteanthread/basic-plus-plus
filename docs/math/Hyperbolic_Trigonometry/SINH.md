...
### 2. Description & Usage
Returns the hyperbolic sine of a number. Evaluates the input and calculates the result mathematically.
...
- **Lexer**: `source/parser/lexer.c` (`KW_SINH`)
- **AST Node**: `source/parser/ast.c` (`FUNC_SINH`)
- **Runtime Evaluation**: `source/math/builtins_math.c -> builtin_sinh()`
...
2. Type: `10 PRINT SINH(0)` and press ENTER.
