...
*   **Boundary Rules**: Dialects configure the Lexer and Parser levels and map implementation-specific keywords to library calls. They are strictly prohibited from modifying core memory-model rules or introducing new virtual machine opcodes.
