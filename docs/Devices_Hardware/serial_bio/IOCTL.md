...
```basic
REM Advanced IOCTL Usage Example
DEFINT A-Z
ON ERROR GOTO ErrorHandler
X$ = IOCTL$("ADVANCED_TEST_VAL")
...
2. Type `OPEN "COM1:9600" FOR RANDOM AS #1`.
3. Type `IOCTL #1, "DTR=1"`.
