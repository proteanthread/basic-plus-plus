...
## 2. Description & Usage
Returns the health status of the stream channel. 0 = Ready/Healthy.

## 3. Code Examples
```basic
10 IF SIOSTATUS(1) <> 0 THEN PRINT "ERROR"
```
...
Parser Expectation: Integer. Read-only.

## 6. Cross-References / See Also
- `BIOSTATUS`

## 7. Historical Context
Standard unified status check.
