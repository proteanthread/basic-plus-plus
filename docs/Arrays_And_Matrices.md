...
31.1  Hard Limits
  ...
  Limit                    Value       Notes
  -----                    -----       -----
  Max arrays               64          Increase MAX_DIM_ARRAYS
  Max dimensions           2           Cannot be changed
  Max elements (total)     8192        Shared across all arrays
  Max subscript value      32767       Same as max line number
