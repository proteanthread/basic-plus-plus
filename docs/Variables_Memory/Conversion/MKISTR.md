...
& Parameters
MKI$(int_expr)
- `int_expr`: An integer numeric expression.

## 2. Description & Usage
Assigns or manages MKISTR functionality in memory.
...
## 3. Code Examples
`asic
REM Deep Example for MKISTR
DEFINT A-Z
ON ERROR GOTO ErrorHandler
MKISTR TEST
PRINT "Executed MKISTR"
END
ErrorHandler:
...
2. Type MKISTR with appropriate parameters.
