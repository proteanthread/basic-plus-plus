...
## 2. Description & Usage
Assigns or manages DEFINT functionality in memory.
...
## 3. Code Examples
`asic
REM Deep Example for DEFINT
DEFINT A-Z
ON ERROR GOTO ErrorHandler
DEFINT TEST
PRINT "Executed DEFINT"
END
ErrorHandler:
...
2. Type DEFINT with appropriate parameters.
