...
## 1. Syntax & Parameters
& Parameters
LSET stringvar$ = string_expr$
- `stringvar$`: A string variable previously defined in a FIELD statement.
- `string_expr$`: The data to place in the buffer.

## 2. Description & Usage
Assigns or manages LSET functionality in memory.
...
2. Type LSET with appropriate parameters.
