...
## 2. Description & Usage
Assigns or manages SHARED functionality in memory.
...
## 3. Code Examples
`asic
REM Deep Example for SHARED
DEFINT A-Z
ON ERROR GOTO ErrorHandler
SHARED TEST
PRINT "Executed SHARED"
END
ErrorHandler:
...
2. Type SHARED with appropriate parameters.
