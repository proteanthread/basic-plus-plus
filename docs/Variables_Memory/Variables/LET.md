...
## 2. Description & Usage
Assigns or manages LET functionality in memory.
...
Implemented in source/variables/let.c and source/parser/parser.c.
...
2. Type LET with appropriate parameters.
