...
& Parameters
SWAP var1, var2
- `var1`, `var2`: Variables to exchange.

## 2. Description & Usage
Assigns or manages SWAP functionality in memory.
...
2. Type SWAP with appropriate parameters.
