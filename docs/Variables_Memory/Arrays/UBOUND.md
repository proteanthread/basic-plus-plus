...
- dimension: (Optional) Which dimension to query (default is 1).

## 2. Description & Usage
Assigns or manages UBOUND functionality in memory.
...
## 3. Code Examples
`asic
REM Deep Example for UBOUND
DEFINT A-Z
ON ERROR GOTO ErrorHandler
UBOUND TEST
PRINT "Executed UBOUND"
END
ErrorHandler:
...
2. Type UBOUND with appropriate parameters.
