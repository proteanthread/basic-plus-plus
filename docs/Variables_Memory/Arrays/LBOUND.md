...
## 2. Description & Usage
Assigns or manages LBOUND functionality in memory.
...
## 3. Code Examples
`asic
REM Deep Example for LBOUND
DEFINT A-Z
ON ERROR GOTO ErrorHandler
LBOUND TEST
PRINT "Executed LBOUND"
END
ErrorHandler:
...
2. Type LBOUND with appropriate parameters.
