...
## 1. Syntax & Parameters
& Parameters
DIM arrayname(size [, size2...]) [AS type]
- rrayname: Name of the array.
- size: Upper bound of the dimension.
- 	ype: Optional data type (INTEGER, SINGLE, DOUBLE, STRING).

## 2. Description & Usage
Assigns or manages DIM functionality in memory.
...
2. Type DIM with appropriate parameters.
