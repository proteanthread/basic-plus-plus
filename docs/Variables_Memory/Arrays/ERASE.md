...
- rrayname: Name of the array to erase.

## 2. Description & Usage
Assigns or manages ERASE functionality in memory.
...
## 3. Code Examples
`asic
REM Deep Example for ERASE
DEFINT A-Z
ON ERROR GOTO ErrorHandler
ERASE TEST
PRINT "Executed ERASE"
END
ErrorHandler:
...
2. Type ERASE with appropriate parameters.
