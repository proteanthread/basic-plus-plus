...
- PRESERVE: Optional. Retains existing data.
- rrayname: Array to resize.

## 2. Description & Usage
Assigns or manages REDIM functionality in memory.
...
## 3. Code Examples
`asic
REM Deep Example for REDIM
DEFINT A-Z
ON ERROR GOTO ErrorHandler
REDIM TEST
PRINT "Executed REDIM"
END
ErrorHandler:
...
2. Type REDIM with appropriate parameters.
