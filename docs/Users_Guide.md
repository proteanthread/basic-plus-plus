...
BASIC++ supports multiple BASIC dialects. By default it starts in GW-BASIC mode, but you can switch to QBasic, TRS-80 CoCo, Tiny BASIC, or Dartmouth BASIC at any time.
...
| Named variables | Up to 31 chars (extended dialects) |
| DIM arrays | Up to 1,024 per program |
