...
static const LangDesc g_space_desc = {
    .name = "SPACE$",
    .category = "String Functions",
    .syntax = "SPACE$(n)",
    .description = "Returns a string consisting of n space characters.",
    .error_summary = "Error 5: Illegal Function Call (n < 0), Error 13: Type Mismatch (SPACE$ expects one numeric argument)",
    .subsystem = SUBSYSTEM_ENGINE,
    .safety = SAFETY_IO,
    .type = FEATURE_FUNCTION
};
void func_space_register(void) {
    lang_desc_register(&g_space_desc);
}
