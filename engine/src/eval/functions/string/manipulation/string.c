...
// NEEDED BY: libengine (abs.c, runtime_acos.c, angle.c, append.c, array_ext.c)
// NEEDED BY: libengine (arrayfill.c, ascii_fn.c, runtime_asin.c, ask.c, assign.c)
// NEEDED BY: libengine (runtime_atan2.c, ath.c, atn.c, auto.c, backspace.c, beep.c)
// NEEDED BY: libengine (bgi.c, bin.c, bios.c, bload.c, brun.c, bsave.c, call.c)
// NEEDED BY: libengine (category.c, cause.c, runtime_ceil.c, chain.c, change.c)
...
// NEEDED BY: libengine (runtime_cos.c, cosh.c, cot.c, create.c, cross.c, csc.c)
...
// NEEDED BY: libengine (exec_internal.h, exec_interrupt.c, exit_loop.c, runtime_exp.c)
// NEEDED BY: libengine (extend.c, external.c, fid.c, field.c, files.c)
// NEEDED BY: libengine (financial.c, find.c, fix.c, runtime_floor.c, for.c, form.c)
...
// NEEDED BY: libengine (linput.c, llist.c, load.c, lock.c, runtime_log.c, log10.c)
...
// NEEDED BY: libengine (return.c, rewind.c, right.c, rmdir.c, rnd.c, runtime_round.c)
...
// NEEDED BY: libengine (shared.c, shell.c, shuffle.c, runtime_sin.c, sinh.c, sleep.c)
...
// NEEDED BY: libengine (runtime_tan.c, tanh.c, task.c, tek.c, test.c, text.c, ticks.c)
...
// NEEDED BY: libengine (system.c, tab.c, runtime_tan.c, tanh.c, task.c, tek.c, test.c)
...
// NEEDED BY: libengine (exit_loop.c, runtime_exp.c, extend.c, external.c, fid.c)
// NEEDED BY: libengine (field.c, files.c, financial.c, find.c, fix.c, runtime_floor.c)
...
// NEEDED BY: libengine (lock.c, runtime_log.c, log10.c, log2.c, loop.c, lpos.c)
...
// NEEDED BY: libengine (right.c, rmdir.c, rnd.c, runtime_round.c, rset.c, rtrim.c)
...
// NEEDED BY: libengine (shuffle.c, runtime_sin.c, sinh.c, sleep.c, sound.c, space.c)
...
// NEEDED BY: libengine (swap.c, sys.c, sys_fn.c, system.c, tab.c, runtime_tan.c)
...
// NEEDED BY: libplatform (plat_thread.c, plat_time.c, platform_core.c)
// NEEDED BY: libstandard (standalone_runner.h)
// NEEDS: libcore (hal.h, memory.h, language_descriptor.h, string.h, strings.h)
...
static const LangDesc g_string_desc = {
    .name = "STRING$",
    ...
    .error_summary = "Error 5: Illegal Function Call (n < 0), Error 13: Type Mismatch (STRING$ argument type error)",
    .subsystem = SUBSYSTEM_ENGINE,
    .safety = SAFETY_IO,
    .type = FEATURE_FUNCTION
};
void func_string_register(void) {
    lang_desc_register(&g_string_desc);
}
...
BValue func_string_eval(VMContext *vm, const char *uname, int arg_count, BValue *args, BppError *err) {
    ...
    if (args[1].type == VAL_NUMBER) {
        ...
        runtime_memset(buf, c, (size_t)n);
        buf[n] = '\0';
        res.type = VAL_STRING;
        res.as.string = str_create(vm_get_str(vm), buf, (size_t)n);
        if (buf && hal_get()) hal_get()->mem.free(buf);
        return res;
    }

    BppStringRef sr = args[1].as.string;
    const char *s = sr ? str_data(sr) : "";
    size_t slen = sr ? str_len(sr) : 0;
    ...
    // Multi-character template string repetition
    size_t total_len = (size_t)n * slen;
    char *buf = (char *)(hal_get() ? hal_get()->mem.alloc(total_len + 1) : NULL);
    if (!buf) {
        if (sr) str_release(vm_get_str(vm), sr);
        err->code = 14;
        err->message = "Out of memory";
    ...
    for (int i = 0; i < n; i++) {
        runtime_memcpy(buf + (i * slen), s, slen);
    }
    buf[total_len] = '\0';

    if (sr) str_release(vm_get_str(vm), sr);
    res.type = VAL_STRING;
    res.as.string = str_create(vm_get_str(vm), buf, total_len);
    if (buf && hal_get()) hal_get()->mem.free(buf);
    return res;
}
