...
BValue func_sin_eval(VMContext *vm, const char *uname, int arg_count, BValue *args, BppError *err) {
    ...
    res.type = VAL_NUMBER;
    res.as.number = runtime_sin(angle);
    return res;
}
