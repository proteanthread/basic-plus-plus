...
#include "statements/introspection/override.h"
...
static const LangDesc g_override_desc = {
    .name = "OVERRIDE",
    ...
    .error_summary = "Error 2: Syntax Error, Error 13: Permission Denied (Protected Keyword)",
...
void stmt_override_register(void) {
    lang_desc_register(&g_override_desc);
}
