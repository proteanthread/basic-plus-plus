...
static const KeywordMap k_keywords[] = {
    ...
    {"COMSPEC", KW_COMSPEC},
    {"LOGNAME", KW_LOGNAME},
    {"HOMEPATH", KW_HOMEPATH},
    {"HOMEDRIVE", KW_HOMEDRIVE},
    {"USERPATH", KW_USERPATH},
    {"COMPUTERNAME", KW_COMPUTERNAME},
    {"TOTALMEM", KW_TOTALMEM},
    {"AVAILMEM", KW_AVAILMEM},
    {"UPTIME", KW_UPTIME},
    {"EPOCH", KW_EPOCH},
    {"UNIXTIME", KW_UNIXTIME},
    {"STARDATE", KW_STARDATE},
    {"_TITLE", KW_TITLE},
    ...
    {"LOGINFO", KW_LOGINFO},
    {"LOGWARN", KW_LOGWARN},
    {"LOGERROR", KW_LOGERROR},
    {"LOGDEBUG", KW_LOGDEBUG},
    {"LOGTRACE", KW_LOGTRACE},
    {"SEND", KW_SEND},
    {"RECEIVE", KW_RECEIVE},
    {"RECEIVE$", KW_RECEIVE},
    {"PUBLISH", KW_PUBLISH},
    {"SUBSCRIBE", KW_SUBSCRIBE},
    {"UNSUBSCRIBE", KW_UNSUBSCRIBE},
    {"UNPUBLISH", KW_UNPUBLISH},
    {"SIGNAL", KW_SIGNAL},
    {"RAISE", KW_RAISE},
    {"PUBSUB", KW_PUBSUB},
    {"MSGSEND", KW_MSGSEND},
    {"MSGRECV", KW_MSGRECV},
    {"MSGRECV$", KW_MSGRECV},
    {"ONSIGNAL", KW_ONSIGNAL},
    {"RAISESIGNAL", KW_RAISESIGNAL},
    {"PIPE", KW_PIPE},
    {"STREAMPIPE", KW_STREAMPIPE},
    {"EXTERN", KW_EXTERN},
    {"YIELD", KW_YIELD},
    {"AWAIT", KW_AWAIT},
    {"NEG", KW_NEG},
