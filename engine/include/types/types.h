...
// NEEDED BY: libcore (language_descriptor.h, module.h, segmented_mem.h)
...
// NEEDED BY: libengine (abs.h, runtime_acos.h, alias.h, alias.c, append.h, ascii_fn.h)
// NEEDED BY: libengine (runtime_asin.h, ask.h, ast.h, ast_internal.h, runtime_atan2.h, ath.h)
...
// NEEDED BY: libengine (runtime_ceil.h, chain.h, change.h, chdir.h, check.h, chr.h)
...
// NEEDED BY: libengine (runtime_cos.h, cosh.h, cot.h, create.h, cross.h, csc.h)
...
// NEEDED BY: libengine (exit_loop.h, runtime_exp.h, external.h, fid.h, field.h)
// NEEDED BY: libengine (files.h, financial.h, fix.h, runtime_floor.h, for.h, form.h)
...
// NEEDED BY: libengine (loc_fn.h, lock.h, lof.h, runtime_log.h, log10.h, log2.h)
...
// NEEDED BY: libengine (runtime_round.h, rset.h, rtrim.h, run.h, save.h)
...
// NEEDED BY: libengine (shared.h, shell.h, shl.h, shr.h, shuffle.h, runtime_sin.h)
...
// NEEDED BY: libengine (sys_fn.h, tab.h, runtime_tan.h, tanh.h, task.h, tek.h, test.h)
...
// NEEDED BY: libcore (keyword_props.h, memory.h, language_descriptor.h)
...
// NEEDED BY: libengine (abs.h, runtime_acos.h, alias.h, append.h, ascii_fn.h, runtime_asin.h)
// NEEDED BY: libengine (ask.h, ast.h, ast_internal.h, runtime_atan2.h, ath.h, atn.h)
...
// NEEDED BY: libengine (category.h, cause.h, runtime_ceil.h, chain.h, change.h)
...
// NEEDED BY: libengine (complex_fn.h, cont.h, continue.h, runtime_cos.h, cosh.h, cot.h)
...
// NEEDED BY: libengine (return.h, right.h, rmdir.h, rnd.h, runtime_round.h, rset.h)
...
// NEEDED BY: libengine (shuffle.h, runtime_sin.h, sinh.h, sound.h, space.h, spc.h)
...
// NEEDED BY: libengine (swap.h, sys.h, sys_fn.h, tab.h, runtime_tan.h, tanh.h, task.h)
...
typedef struct BppSet BppSet;
typedef struct BppGroup BppGroup;
...
typedef enum {
    ...
    VAL_SET,            // first-class Set collection
    VAL_GROUP           // addressable Group within a Set
} ValueType;
...
typedef struct {
    ...
    union {
        ...
        BppSet      *set;    // reference-counted Set collection
        BppGroup    *group;  // reference-counted Group within a Set
