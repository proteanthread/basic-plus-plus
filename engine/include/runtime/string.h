...
// Implements component functionality for string.h.
//
// ---- Includes ----
...
// NEEDED BY: libengine (stop.c, str.c, str_math.c, string.c, string_fn.c)
...
// NEEDED BY: libengine (stmt_plot.c, stop.c, str.c, str_math.c, string.c)
// NEEDED BY: libengine (string_fn.c, sub_internal.h, suspend.c, swap.c, sys.c)
// NEEDED BY: libengine (sys_fn.c, system.c, tab.c, runtime_tan.c, tanh.c, task.c)
// NEEDED BY: libengine (tek.c, test.c, text.c, ticks.c, time.c, time_fn.c)
// NEEDED BY: libengine (timer.c, trim.c, truncate.c, try.c, txn.c, type.c)
...
// NEEDED BY: libplatform (plat_thread.c, plat_time.c, platform_core.c)
// NEEDED BY: libstandard (standalone_runner.h)
// NEEDS: libcore (ctype.h, float_parse.h, memops.h, num_parse.h, runtime_snprintf.h)
// NEEDS: libcore (strops.h)
// NEEDS: libcore (ctype.c, float_parse.c, memops.c, num_parse.c, runtime_snprintf.c)
// NEEDS: libcore (strops.c)
// Top-level umbrella header for freestanding string operations.
//
// ---- Includes ----
