...
/**
 * @file num_format.h
 * @brief Runtime component implementation and public API surface for num_format.h.
 *
 * WHAT IT DOES:
 * Implements the core responsibilities, data structures, and function evaluation logic for num_format.h within the runtime subsystem.
 *
 * WHY IT EXISTS:
 ...
 * - Future extensions may define custom display precision via configuration
