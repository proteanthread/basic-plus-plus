...
// NEEDED BY: libcore (qsort.c, regex.c, segmented_mem.c, runtime_snprintf.c, sscanf.c)
...
// NEEDED BY: libcore (regex.c, segmented_mem.c, runtime_snprintf.c, sscanf.c, strops.c)
