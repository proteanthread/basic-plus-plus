...
// VERSION: 6.5.2.0
// NEEDED BY: libboot, libcore, libengine, libext, libkernel, libplatform, libserver, libstandard
// NEEDS: libcore (arrays.h, arrays.c, memory.h, memory.c)
// NEEDS: libcore (metadata.h, metadata.c, strings.h, strings.c)
// NEEDS: libcore (variables.h, variables.c)
// NEEDS: libkernel (types.h)
// Implements component functionality for vm.h.
//
// ---- Includes ----
...
typedef struct BppSessionContext BppSessionContext;
...
int              vm_get_margin(VMContext *vm);
...
// @brief Push a multi-variable loop frame onto the FOR loop stack.
...
// Watchdog Timer & Execution Cycle Limit APIs
