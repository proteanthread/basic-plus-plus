...
/**
 * @file let.h
 * @brief Public interface header for LET and SWAP statement handlers.
 *
 * 1. WHAT IT DOES:
 * Declares public handler functions stmt_let_handler() and stmt_swap_handler().
 *
 * 2. WHY IT EXISTS:
 * Exposes public API interface allowing VM statement dispatcher to handle variable assignment and exchange statements.
 *
 * 3. WHY IT WORKS THIS WAY:
 * Conforms to standard statement handler signature BppError (*)(VMContext*, LexerContext*).
 *
 * 4. DEPENDENCIES & COMPILATION:
 * Micro-library target 'stmt_let'. Includes "types/types.h", "vm/vm.h", "lexer/lexer.h".
 *
 * 5. EDITION INCLUSION & EXCLUSION:
 * Included in all editions ('baspp', 'bpp', 'bs').
 *
 * 6. HOW TO MODIFY OR EXTEND IT:
 * Add multi-target assignment helper prototypes.
 *
 ...
 * Verify header guard STATEMENTS_VARIABLES_LET_H and include surfaces.
 *
