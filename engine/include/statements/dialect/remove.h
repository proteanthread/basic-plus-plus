...
/**
 * @file remove.h
 * @brief Header for REMOVE language feature unregistration statement handler.
 *
 * SECTION 1: WHAT IT DOES, WHY IT EXISTS, AND WHY IT WORKS THIS WAY
 * - What it does: Declares the entry point function for REMOVE statement execution.
