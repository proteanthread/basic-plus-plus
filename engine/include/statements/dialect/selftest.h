...
/**
 * @file selftest.h
 * @brief Header for SELFTEST diagnostic suit execution statement handler.
 *
 * SECTION 1: WHAT IT DOES, WHY IT EXISTS, AND WHY IT WORKS THIS WAY
 * - What it does: Declares the entry point function for SELFTEST statement execution.
...
#ifndef STATEMENTS_DIALECT_SELFTEST_H
#define STATEMENTS_DIALECT_SELFTEST_H
...
#endif /* STATEMENTS_DIALECT_SELFTEST_H */
