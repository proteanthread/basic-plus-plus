...
/**
 * @file joystick.h
 * @brief Public interface header for STICK and STRIG game controller statement handlers.
 *
 * 1. WHAT IT DOES:
 * Declares public handler functions stmt_joystick_handler() and stmt_trig_handler().
 *
 * 2. WHY IT EXISTS:
 * Exposes public API interface allowing VM statement dispatcher to handle game controller event trapping statements.
 *
 * 3. WHY IT WORKS THIS WAY:
 * Conforms to standard statement handler signature BppError (*)(VMContext*, LexerContext*).
 *
 * 4. DEPENDENCIES & COMPILATION:
 * Micro-library target 'stmt_joystick'. Includes "types/types.h", "vm/vm.h", "lexer/lexer.h".
 *
 * 5. EDITION INCLUSION & EXCLUSION:
 * Standard Edition ('baspp') strictly per Rule #1 (Excluded Subsystems from bpp/bs). Excluded from 'bpp' and 'bs'.
 *
 * 6. HOW TO MODIFY OR EXTEND IT:
 * Add game controller polling mode prototypes.
 *
 ...
 * Verify header guard STATEMENTS_SYSTEM_JOYSTICK_H and include surfaces.
 *
 ...
 * - engine/src/statements/system/joystick.c
