...
// VERSION: 6.5.2.0
// NEEDED BY: libengine (ascii_fn.c, string_fn.c)
...
#ifndef EVAL_FUNCTIONS_STRING_ASCII_FN_H
#define EVAL_FUNCTIONS_STRING_ASCII_FN_H
...
#endif // EVAL_FUNCTIONS_STRING_ASCII_FN_H
