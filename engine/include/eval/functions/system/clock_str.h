...
/**
 * @file clock_str.h
 * @brief Public interface header for CLOCK$ ISO date/time string function evaluator micro-library.
 *
 * 1. WHAT IT DOES:
 * Declares public entry point `func_clock_str_eval()` and metadata registration `func_clock_str_register()` for CLOCK$ function.
 *
 * 2. WHY IT EXISTS:
 ...
 * Micro-library target 'func_clock_str'. Includes "types/types.h", "eval/eval_internal.h".
 *
 * 5. EDITION INCLUSION & EXCLUSION:
 * Included in all editions ('baspp', 'bpp', 'bs').
 *
 * 6. HOW TO MODIFY OR EXTEND IT:
 * Add ISO date/time string formatting inline macro helpers.
 *
 * 7. WHAT CANNOT BE CHANGED:
 * Public function prototypes func_clock_str_eval() and func_clock_str_register().
 *
 * 8. WHAT TO EXPECT:
 * Declares BValue return types and void registration entry points.
 *
 * 9. WHAT TO DO IF SOMETHING BREAKS:
 * Verify header guard EVAL_FUNC_CLOCK_STR_H and include surfaces.
 *
 ...
 * - engine/src/eval/functions/system/clock_str.c
