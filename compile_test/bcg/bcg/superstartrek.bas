...
70 REM **** ORIGIONAL PROGRAM BY MIKE MAYFIELD, MOD IF IED VERSION
...
1680 A$="<*>":Z1=S1:Z2=S2:GOSUB8670: IF K3<1 THEN 1820
1720 FOR I=1 TO K3:GOSUB8590:A$="+K+":Z1=R1:Z2=R2
1780 GOSUB8670:K(I,1)=R1:K(I,2)=R2:K(I,3)=S9*(0.5+RND(1)):NEXT I
1820 IF B3<1 THEN 1910
1880 GOSUB8590:A$=">!<":Z1=R1:B4=R1:Z2=R2:B5=R2:GOSUB8670
1910 FOR I=1 TO S3:GOSUB8590:A$=" * ":Z1=R1:Z2=R2:GOSUB8670:NEXT I
1980 GOSUB6430
1990 IF S+E>10THEN IF E>10 OR D(7)=0 THEN 2060
...
2700 NEXT I:GOSUB6000:D1=0:D6=W1: IF W1>=1 THEN D6=1
...
3870 T=T+1:GOSUB3910: GOTO 1320
...
4670 NEXT I:GOSUB6000: GOTO 1990
...
5060 A$="+K+":Z1=X:Z2=Y:GOSUB8830: IF Z3=0 THEN 5210
...
5210 A$=" * ":Z1=X:Z2=Y:GOSUB8830: IF Z3=0 THEN 5280
5260 PRINT"STAR AT";X3;",";Y3;"ABSORBED TORPEDO ENERGY.":GOSUB6000: GOTO 1990
5280 A$=">!<":Z1=X:Z2=Y:GOSUB8830: IF Z3=0 THEN 4760
...
5470 G(Q1,Q2)=K3*100+B3*10+S3:Z(Q1,Q2)=G(Q1,Q2):GOSUB6000: GOTO 1990
5490 PRINT"TORPEDO MISSED":GOSUB6000: GOTO 1990
...
5920 GOSUB8790:PRINT G2$;LEFT$(Z$,25-LEN(G2$));INT(D(R1)*100)*.01
...
6820 FOR J=(I-1)*24+1TO(I-1)*24+22STEP3:PRINT" ";MID$(Q$,J,3);:NEXT J
...
7740 Z4=I:Z5=1:GOSUB9030:J0=INT(15-.5*LEN(G2$)):PRINT TAB(J0);G2$;
