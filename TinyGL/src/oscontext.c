// FILENAME: oscontext.c
// LICENSE: Copyleft (c) 2026 BASIC++ Community — All Wrongs Reserved
// VERSION: 6.5.2.0
// NEEDED BY: libcore (GLView.h)
// NEEDS: libcore (gl.h, zbuffer.h, zbuffer.c, zgl.h)
// NEEDS: libext (oscontext.h)
// Provides core logic and interface definitions for oscontext within BASIC++.
//
// ---- Includes ----
