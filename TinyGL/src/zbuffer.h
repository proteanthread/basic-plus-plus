...
// VERSION: 6.5.2.0
// NEEDED BY: libcore (zbuffer.c, zdither.c, zgl.h, zline.c, ztriangle.c)
// NEEDED BY: libext (oscontext.c)
// NEEDS: libcore (zfeatures.h)
// Provides core logic and interface definitions for zbuffer within BASIC++.
//
// ---- Includes ----
