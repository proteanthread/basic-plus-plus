...
// VERSION: 6.5.2.0
// NEEDED BY: libcore (api.c, arrays.c, clear.c, clip.c, error.c, get.c, glx.c)
// NEEDED BY: libcore (image_util.c, init.c, light.c, list.c, matrix.c)
// NEEDED BY: libcore (memory.c, misc.c, nglx.c, select.c, specbuf.c, vertex.c)
// NEEDED BY: libext (oscontext.c, texture.c)
// NEEDS: libcore (gl.h, math.h, opinfo.h, string.h, zbuffer.h, zbuffer.c)
// NEEDS: libcore (zfeatures.h, zmath.h, zmath.c)
// NEEDS: libengine (math.c, string.c)
// Provides core logic and interface definitions for zgl within BASIC++.
//
// ---- Includes ----
