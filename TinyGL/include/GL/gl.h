...
// VERSION: 6.5.2.0
// NEEDED BY: libcore (GLView.h, gears.c, glu.c, glx.h, mech.c, nanox.c)
// NEEDED BY: libcore (nglx.h, nglx.c, spin.c, texobj.c, x11.c, zgl.h)
// NEEDED BY: libext (oscontext.c)
// NEEDS: platform, memory
// Provides core logic and interface definitions for gl within BASIC++.
//
// ---- Includes ----
